...
const Index = () => {
  useEffect(() => {
    ...
    link1.href = 'https://fonts.googleapis.com/css2?family=Oswald:wght@400;600;700&display=swap';
    link1.rel = 'stylesheet';
    document.head.appendChild(link1);

    const link2 = document.createElement('link');
    link2.href = 'https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;500;600&display=swap';
